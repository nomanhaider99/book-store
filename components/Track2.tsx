...
<path fill-rule="evenodd" clip-rule="evenodd" d="M144.876 113.724C143.745 116.249 142.653 118.936 141.874 121.497C140.675 125.494 140.161 129.15 141.147 131.812C141.454 133.14 142.793 133.964 144.113 133.643C145.441 133.335 146.265 131.996 145.943 130.677C145.875 130.018 146.105 129.335 146.322 128.567C146.819 126.756 147.931 124.866 149.141 122.827C150.687 120.227 152.547 117.63 154.133 115.227C155.577 113.053 156.781 111.036 157.547 109.437C158.756 106.922 158.822 104.809 158.548 103.572C158.472 103.249 155.79 98.4452 151.204 100.359C149.564 101.048 145.501 103.009 145.3 103.106C142.859 104.443 138.324 106.859 134.005 108.122C132.64 108.525 131.322 108.882 130.122 108.932C130.058 108.822 129.994 108.712 129.917 108.61C128.796 107.018 126.615 106.643 125.015 107.75C124.128 108.281 122.971 109.775 122.661 110.669C122.068 112.407 122.729 113.807 124.351 114.963C126.56 116.533 129.757 116.982 133.351 116.688C137.128 116.361 141.407 115.029 144.876 113.724ZM148.865 105.656C149.133 105.134 149.224 104.751 148.863 104.666C148.458 104.569 148.727 105.259 148.865 105.656Z" fill="#4D2C5E"/>
        ...
        <div className='flex items-center justify-center px-32 translate-y-0'>
            <div className='bg-white w-[25vw] h-[25vw] rounded-xl'>
                <div className="image flex justify-center translate-y-4 ">
                <Image src="https://images.pexels.com/photos/927022/pexels-photo-927022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt='bman' height={100} className='rounded-xl' width={350}/>
                </div>
                <div className="text-area py-5 ml-8 px-2">
                    <h2 className='text-black font-bold'>Matthew E. McNatt</h2>
                    <p className='text-zinc-500 text-xs'>Professor @George Brown College</p>
                    <p className='text-zinc-600 font-semibold text-sm'>Ut enim ad minim veniam, quis nost exercitation
                    ullamco laboris nisi ut allquip ex commodo.</p>
                    <button className='text-[#FF7426] font-bold mt-6 cursor-pointer'>Engineering Physics</button>
                </div>
                </div> 
            
                <div className='bg-white w-[25vw] h-[25vw] rounded-xl mx-4'>
                <div className="image flex justify-center translate-y-4 ">
                <Image src="https://images.pexels.com/photos/859264/pexels-photo-859264.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt='bman' height={100} className='rounded-xl' width={350}/>
                </div>
                <div className="text-area py-5 ml-8 px-2">
                    <h2 className='text-black font-bold'>Tracy D. Wright</h2>
                    <p className='text-zinc-500 text-xs'>Professor @Tracy Wright College</p>
                    <p className='text-zinc-600 font-semibold text-sm'>Ut enim ad minim veniam, quis nost exercitation
                    ullamco laboris nisi ut allquip ex commodo.</p>
                    <button className='text-[#FF7426] font-bold mt-6 cursor-pointer'>Engineering Physics</button>
                </div>
                ...
                <div className='bg-white w-[25vw] h-[25vw] rounded-xl '>
                <div className="image flex justify-center translate-y-4 ">
                <Image src="https://images.pexels.com/photos/1181676/pexels-photo-1181676.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt='bman' height={100} className='rounded-xl' width={350}/>
                </div>
                <div className="text-area py-5 ml-8 px-2">
                    <h2 className='text-black font-bold'>Cyntia .A Albert</h2>
                    <p className='text-zinc-500 text-xs'>Professor @George Brown College</p>
                    <p className='text-zinc-600 font-semibold text-sm'>Ut enim ad minim veniam, quis nost exercitation
                    ullamco laboris nisi ut allquip ex commodo.</p>
                    <button className='text-[#FF7426] font-bold mt-6  cursor-pointer'>Engineering Physics</button>
